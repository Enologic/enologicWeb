...
@section('profile')
    ...
    <div class="container mt-3">
        ...
        <h1 class="text-center pb-1"><span class="rounded-pill title-custom px-3">Profile</span></h1>
        <div class="container d-flex align-items-center justify-content-between">

            <div class="col-12 text-end pe-4">
                {{-- Botón para volver a SHOW --}}
        ...
        <div class="container mb-4 d-flex justify-content-center">
            ...
            <div class="col-md-8 card mb-3">
                ...
                <div class="card-body">
                    <ul class="mb-0">
                        <li><strong class="text-dark">Username:</strong> {{ $user->username }}</li>
                        <li><strong class="text-dark">Email:</strong> {{ $user->email }}</li>
                        <li><strong class="text-dark">Phone:</strong> {{ $user->phone }}</li>
                        <li><strong class="text-dark">Name:</strong> {{ $user->name }}</li>
                    </ul>
                </div>

                <div class="card-footer text-center">
                    <button type="button" class="col-4 btn btn-dark" data-bs-toggle="modal"
        ...
        <div class="container mb-4 d-flex justify-content-center">
            <div class="col-md-8 card mb-3">
                ...
                <div class="card-body">
                    ...
                    @isset($addresses)
                        @if ($addresses->isNotEmpty())
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-center bg-dark">
                                                    ...
                                                    <form id="deleteAddressForm{{ $address->id }}"
                                                        action="{{ route('address.delete') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="address_id" value="{{ $address->id }}">
                            ...
                            @endforeach
                        @else
                            <p class="mb-0 mt-2">No hay información de dirección disponible.</p>
                        @endif
                    @else
                        <p class="mb-0 mt-2">No hay información de dirección disponible.</p>
                    @endisset
                ...
                <div class="card-footer text-center">
                    <button type="button" class="mt-3 btn btn-dark col-4" data-bs-toggle="modal"
        ...
        <div class="modal fade" id="addAddressModal" tabindex="-1" aria-labelledby="addAddressModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-dark text-white">
                        <h5 class="modal-title" id="addAddressModalLabel">New Address</h5>
