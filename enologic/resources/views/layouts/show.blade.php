...
<div class="modal fade" id="addProductModal{{ $product->id }}" tabindex="-1" aria-labelledby="addProductModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <form action="{{ route('cart.add', ['productId' => $product->id]) }}" method="post">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="addProductModalLabel">{{ $product->product_name }}</h5>
