    ...
    <table class="table mt-3">
        ...
        <tbody>
            ...
            <tr class="align-middle">
                ...
                <td class="text-center"><a href="#deleteModal{{ $product->id }}" id="img-style-size" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $product->id }}">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="align-middle">
                            ...
                            <td id="quantityModal{{ $product->id }}" class="text-center">{{ $product->pivot->quantity }}</td>
                            <td id="subtotalModal{{ $product->id }}" class="text-center">{{ $product->price * $product->pivot->quantity }} €</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
