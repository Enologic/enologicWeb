            ...
            <tr class="align-middle">
                ...
                <td>
                    <div class="d-flex justify-content-center">
                        ...
                        <a href="#editModal{{ $product->id }}" id="img-style-size" class="btn btn-warning mx-1" data-bs-toggle="modal" data-bs-target="#editModal{{ $product->id }}">
                            <i class="fa-solid fa-pencil"></i>
                        </a>
                        {{-- Botón para eliminar un Producto --}}
                        <a href="#deleteModal{{ $product->id }}" id="img-style-size" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $product->id }}">
