                            ...
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    if (response.discount_percentage) {
                                        ...
                                        $('#totalAmount').html('<del style="color: black;">' + currentTotal
                                            .toFixed(2) + '</del> <span style="color: red;">' + newTotal
                                            .toFixed(2) + '</span>');
                                ...
                                error: function(xhr, status, error) {
                                    alert(
                                        'Se produjo un error al aplicar el cupón. Por favor, inténtalo de nuevo.'
                                        );
                                }
                            });
                        });
                ...
                <form class="needs-validation" method="POST" action="{{ route('confirmar.pedido') }}">
                    ...
                    <div class="row g-1">
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control direccion" id="street" name="street"
                                value="{{ $addresses->isNotEmpty() ? $addresses->first()->street : '' }}" required="">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control direccion" id="country" name="country"
                                value="{{ $addresses->isNotEmpty() ? $addresses->first()->country : '' }}" required="">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control direccion" id="city" name="city"
                                value="{{ $addresses->isNotEmpty() ? $addresses->first()->city : '' }}" required="">
                            <div class="invalid-feedback">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control direccion" id="zipcode" name="zipcode"
                                value="{{ $addresses->isNotEmpty() ? $addresses->first()->zipcode : '' }}" required="">
                            <div class="invalid-feedback">
                                Zip code required.
                            </div>
                        </div>
                ...
                <script>
                    $(document).ready(function() {
                        $('#selectDireccion').change(function() {
                            ...
                            let selectedAddress = {!! json_encode($addresses) !!}.find(address => address.id ==
                                selectedAddressId);
                            if (selectedAddress) {
